...
if __name__ == "__main__":
    ...
    print(f"Address API: {IP_ADDRESS_API}")
    test_req1 = requests.get(f"http://{IP_ADDRESS_API}:3001/news?country=gr")
    ...
    test_req2 = requests.get(f"http://{IP_ADDRESS_API}:3001/weather?city=amsterdam")
